...
/*
    ...
    */
    ...
    fn_dirFHaarWT2p2oneStage(ai_k, ai_data, 8);                                 // dirFWT
    ...
    fn_invFHaarWT2p2oneStage(ai_data, ai_k, 8);                                 // invFWT
    ...
    fn_dirFHaarWT2p2(ai_k, ai_data, 8, 1);                                      // dirFWT
    ...
    fn_invFHaarWT2p2(ai_data, ai_k, 8, 1);                                      // invFWT
    ...
    fn_dirFHaarWT2p2(ai_k, ai_data, 8, i_step);                                 // dirFWT
    ...
    fn_invFHaarWT2p2(ai_data, ai_k, 8, i_step);                                 // invFWT
    ...
    fn_dirFHaarWT2p2(ai_Rk, ai_Rdata, RANGE, i_Rstep);                          // dirFWT
    ...
    fn_invFHaarWT2p2(ai_Rdata, ai_Rk, RANGE, i_Rstep);                          // invFWT
    ...
    fn_dirFHaarWT2p2(ai_Rk, ai_Rdata, RANGE, 3);                                // dirFWT
    ...
    fn_invFHaarWT2p2(ai_Rdata, ai_Rk, RANGE, 3);                                // invFWT
