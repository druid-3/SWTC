...
/*
    ...
    */
    ...
    fn_dirUniversalFWToneStage_NoaK(a_k, &a_k[4], a_data, 8, a4WHPF, a4WLPF, 2); // dirFWT
    ...
    fn_invUniversalFWToneStage_NoaK(a_data, a_k, &a_k[4], 8, a4WHPF, a4WLPF, 2); // invFWT
    ...
    memset(a_k, 0, sizeof(a_k));
    fn_dirUniversalFWT_NoaK(a4p2wki, a_data, 8, 1, a4WHPF, a4WLPF, 2);          // dirFWT
    ...
    memset(a_data, 0, sizeof(a_data));
    fn_invUniversalFWT_NoaK(a_data, a4p2wki, 8, 1, a4WHPF, a4WLPF, 2);          // invFWT
    ...
    memset(a_k, 0, sizeof(a_k));
    fn_dirUniversalFWT_NoaK(a4p2wki, a_data, 8, i_step, a4WHPF, a4WLPF, 2);     // dirFWT
    ...
    printf( "\n" );
    memset(a_data, 0, sizeof(a_data));
    fn_invUniversalFWT_NoaK(a_data, a4p2wki, 8, i_step, a4WHPF, a4WLPF, 2);     // invFWT
    ...
    fn_dirUniversalFWT_NoaK(a4p2wkiR, a_Rdata, RANGE, i_Rstep, a4WHPF, a4WLPF, 2); // dirFWT
    ...
    fn_invUniversalFWT_NoaK(a_Rdata, a4p2wkiR, RANGE, i_Rstep, a4WHPF, a4WLPF, 2); // invFWT
    ...
    memset(a_Rk, 0, sizeof(a_Rk));
    fn_dirUniversalFWT_NoaK(a4p2wkiR, a_Rdata, RANGE, 3, a4WHPF, a4WLPF, 2);    // dirFWT
    ...
    memset(a_Rdata, 0, sizeof(a_Rdata));
    fn_invUniversalFWT_NoaK(a_Rdata, a4p2wkiR, RANGE, 3, a4WHPF, a4WLPF, 2);    // invFWT
